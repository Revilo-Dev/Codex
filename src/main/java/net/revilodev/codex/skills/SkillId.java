...
public enum SkillId {
    SHARPNESS(SkillCategory.COMBAT, "Sharpness", ResourceLocation.parse("minecraft:iron_sword"), "Increases melee damage.", 25),
    POWER(SkillCategory.COMBAT, "Power", ResourceLocation.parse("minecraft:bow"), "Increases ranged damage.", 25),
    CRIT_BONUS(SkillCategory.COMBAT, "Crit Bonus", ResourceLocation.parse("minecraft:netherite_sword"), "Increases critical damage bonus.", 30),
    ...
    HEALTH(SkillCategory.SURVIVAL, "Health", ResourceLocation.parse("minecraft:heart_of_the_sea"), "Increases max health.", 20),
    REGENERATION(SkillCategory.SURVIVAL, "Regeneration", ResourceLocation.parse("minecraft:ghast_tear"), "Increases passive regeneration.", 10),
    SWIFTNESS(SkillCategory.SURVIVAL, "Swiftness", ResourceLocation.parse("minecraft:sugar"), "Increases movement speed.", 25),
    DEFENSE(SkillCategory.SURVIVAL, "Defense", ResourceLocation.parse("minecraft:iron_chestplate"), "Increases armor.", 25),
    ...
    EFFICIENCY(SkillCategory.UTILITY, "Efficiency", ResourceLocation.parse("minecraft:iron_pickaxe"), "Increases mining speed.", 25),
    ...
    FORTUNE(SkillCategory.UTILITY, "Fortune", ResourceLocation.parse("minecraft:emerald"), "Improves loot/luck outcomes from chests.", 25),
    LOOTING(SkillCategory.UTILITY, "Looting", ResourceLocation.parse("minecraft:chest"), "Improves loot drops from mobs.", 25);
